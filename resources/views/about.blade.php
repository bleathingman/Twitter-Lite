                ...
                <div class="card-body">
                    ...
                    <div class="shadow-none p-3 mb-5 bg-light rounded">
                        <h5>Ce site est le projet de stage de Silinox et Bleathingman, réaliser du 3 juin jusqu'au 5
                            ...
                            2019.</h5>
                        <h5>Site web : <a
                                href="http://twitter-lite.localtunnel.me">http://twitter-lite.localtunnel.me</a></h5>
                        <br />
                        ...
                        <h5>Un grand merci à notre maître de stage sans qui tout cela aurait été impossible !<h5>
                                ...
                                <br />
                                <br />
                                <h5>Serveur discord des développeurs (Venez c'est gratuit) :</h5>
                                <a href="https://discord.gg/DkZMXgS" class="btn btn-primary">Silinox</a> &nbsp; <a
                                    href="https://discord.gg/eRuY36F" class="btn btn-primary">Bleathingman</a>
                    </div>
                </div>
            </div>
        </div>
